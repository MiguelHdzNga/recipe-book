#CUESTIONARIO REACCIONES MAESTRO
...
preguntas= [["¿NaCl?", "Ambas", "Azucar", "Sal"]]
preguntas.append(["¿Que hace el polvo para hornear?", "Expande", "Infla", "Ambas"])
preguntas.append(["¿Que consistencia tiene la avena cuando se calienta con leche?","Solida", "Liquida", "Viscoza"])
preguntas.append(["Cuando algo se congela se convierte en un:", "Liquido", "Gas", "Solido"])
preguntas.append(["Cuando se corta un trozo de manzana y pasa el tiempo, esta se:", "Ambas", "Derrite", "Oxida"])
