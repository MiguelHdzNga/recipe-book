#CUESTIONARIO CONVERSIONES MAESTRO
...
preguntas= [["1 masa de pizza se prepara con 35 g de sal, ¿Cuántos g necesito para 36 pizzas?", "1020 g", "100 g", "1260 g"]]
preguntas.append(["2 batidos se prepara con 10 fresas, ¿Cuántas fresas necesito para 8 batidos?", "20", "30", "40"])
preguntas.append(["¿25 Kg + 65 Kg?", "30 g", "26 g", "90 g"])
preguntas.append(["¿1020 g + 50 g?", "1920 g", "1030 g", "1070 g"])
preguntas.append(["Una malteada se prepara con 10 mL de nieve, ¿Cuántos mL necesito para 9 malteadas? ", "100 mL", "92 mL", "90 mL"])
preguntas.append(["Para 1 volcan de queso se agregan 2 g de sal, ¿Cuántos g necesito para 13 volcanes? ", "16 g", "32 g", "26 g"])
...
def preguntaVentana(textopregunta):
    preguntaEnVentana= Text(ventana, font=fuente, width=80, height=1)
